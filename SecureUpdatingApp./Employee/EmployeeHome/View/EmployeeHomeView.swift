...
class EmployeeHomeView: UIView {
    ...
    required init?(coder: NSCoder) {
        ...
        SecureTextFieldModifier.modifyTextFields(textField: placeOfBirthTextfield, radius: 20.0)
        SecureTextFieldModifier.modifyTextFields(textField: dateOfBirthTextfield, radius: 20.0)
    }
